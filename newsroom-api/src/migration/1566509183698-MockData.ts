import {FindConditions, MigrationInterface, QueryRunner} from "typeorm";
...
export class MockData1566509183698 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await documentRepository.delete(await documentRepository.findOne({where: {name: this.DOCUMENT_NAME}}));

        await workflowRepository.delete(await workflowRepository.findOne({where: {name: this.WORKFLOW_NAME}}));
