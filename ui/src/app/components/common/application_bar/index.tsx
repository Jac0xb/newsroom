    ...
    render() {
        ...
        const sideMenuList = (
            <div className={classes.list}>
                <List>
                    <Link to="/" className={classes.itemLinks}>
                        <ListItem button>
                            <ListItemIcon><HomeIcon/></ListItemIcon>
                            <ListItemText>Document</ListItemText>
                        </ListItem>
                    </Link>
                    <Link to="/workflow" className={classes.itemLinks}>
                        <ListItem button>
                            <ListItemIcon><MailIcon/></ListItemIcon>
                            <ListItemText>Workflow</ListItemText>
                        </ListItem>
                    </Link>
                    <Link to="/users" className={classes.itemLinks}>
                        <ListItem button>
                            <ListItemIcon><AccountCircleIcon/></ListItemIcon>
                            <ListItemText>Users</ListItemText>
                        </ListItem>
                    </Link>
                    <Link to="/groups" className={classes.itemLinks}>
                        <ListItem button>
                    ...
                    <ListItem button onClick={() => {
                        cookies.set('username', prompt("What is your new user's name?"))
                    }}>
                ...
                <AppBar style={{backgroundColor: "#cfd8dc", boxShadow: 'none'}} position="static">
                    <Toolbar>
                        ...
                        <Link style={{textDecoration: "none"}} to="/">
                            <Typography style={{textDecoration: "none"}} className={classes.title} variant="title"
